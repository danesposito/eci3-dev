...
class IndicatorTypesControllerTest < ActionController::TestCase
  ...
  test "should create indicator_type" do
    assert_difference('IndicatorType.count') do
      post :create, indicator_type: { description: @indicator_type.description, name: @indicator_type.name, weight: @indicator_type.weight }
    end
  ...
  test "should update indicator_type" do
    patch :update, id: @indicator_type, indicator_type: { description: @indicator_type.description, name: @indicator_type.name, weight: @indicator_type.weight }
    assert_redirected_to indicator_type_path(assigns(:indicator_type))
  end
